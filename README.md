...
本项目深受 wildminder 的 [AI-windows-whl](https://github.com/wildminder/AI-windows-whl){:target="_blank"} 项目的启发，我们旨在延续其精神，为更广泛的 Windows AI 社区提供稳定可靠的预编译资源。
...
1.  **Windows 版 Python**：请确认本地安装的 Python 版本与 PyTorch 支持范围一致（当前为 **3.9 - 3.14**）。可前往 [Python 官网](https://www.python.org/downloads/windows/){:target="_blank"} 下载。
...
### PyTorch
万物根基，优先走官方通道安装。
*   **官方安装页面**： [https://pytorch.org/get-started/locally/](https://pytorch.org/get-started/locally/){:target="_blank"}
...
|:---:|:---:|:---:|:---:|:---:|
| `2.8.0a0` | `2.10.0` | `3.13` | `13.0` | [Link](https://huggingface.co/Wildminder/AI-windows-whl/resolve/main/torchaudio-2.8.0a0+cu130torch2.10.0cxx11abi1-cp313-cp313-win_amd64.whl){:target="_blank"} |
| `2.8.0` | `2.9.0` | N/A | `12.8` | [Link](https://huggingface.co/Wildminder/AI-windows-whl/resolve/main/torchaudio-2.8.0a0%2Bcu128torch2.9.0cxx11abi1-cp312-cp312-win_amd64.whl?download=true){:target="_blank"} |
...
### Flash Attention
高性能注意力实现。
*   **官方仓库**： [Dao-AILab/flash-attention](https://github.com/Dao-AILab/flash-attention){:target="_blank"}
*   **预编译来源**： [lldacing 的 HF](https://huggingface.co/lldacing/flash-attention-windows-wheel/tree/main){:target="_blank"}、[Wildminder 的 HF](https://huggingface.co/Wildminder/AI-windows-whl/tree/main){:target="_blank"}、[mjun0812 GitHub](https://github.com/mjun0812/flash-attention-prebuild-wheels){:target="_blank"}
...
### xformers
内存友好的注意力及优化组件库。
*   **官方仓库**： [facebookresearch/xformers](https://github.com/facebookresearch/xformers/releases){:target="_blank"}
*   **PyTorch 官方索引**： [https://download.pytorch.org/whl/xformers/](https://download.pytorch.org/whl/xformers/){:target="_blank"}
> [!NOTE]
...
### SageAttention
*   **官方仓库**： [thu-ml/SageAttention](https://github.com/thu-ml/SageAttention){:target="_blank"}
*   **预编译来源**： [woct0rdho 发布页](https://github.com/woct0rdho/SageAttention/releases){:target="_blank"}、[Wildminder 的 HF](https://huggingface.co/Wildminder/AI-windows-whl/tree/main){:target="_blank"}
...
## SpargeAttn  
*   **官方仓库**： [thu-ml/SpargeAttn](https://github.com/thu-ml/SpargeAttn){:target="_blank"}
*   **预编译来源**： [woct0rdho 发布页](https://github.com/woct0rdho/SpargeAttn/releases){:target="_blank"}
...
### Nunchaku
*   **官方仓库**： [mit-han-lab/nunchaku](https://github.com/mit-han-lab/nunchaku/releases){:target="_blank"}
...
*   **官方仓库**： [SHI-Labs/NATTEN](https://github.com/SHI-Labs/NATTEN){:target="_blank"}
*   **预编译来源**： [lldacing 的 HF](https://huggingface.co/lldacing/NATTEN-windows/tree/main){:target="_blank"}
...
*   **Windows Fork**： [woct0rdho/triton-windows](https://github.com/woct0rdho/triton-windows/releases){:target="_blank"}
...
*   **官方仓库**： [bitsandbytes-foundation/bitsandbytes](https://github.com/bitsandbytes-foundation/bitsandbytes){:target="_blank"}

****

### RadialAttention for ComfyUI
*   **节点**： [ComfyUI-RadialAttn](https://github.com/woct0rdho/ComfyUI-RadialAttn){:target="_blank"}
